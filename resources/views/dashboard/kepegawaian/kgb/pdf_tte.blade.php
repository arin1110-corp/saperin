...
<body>
    ...
    @php
        ...
        */
        ...
        $formatNama = function ($value) {
            ...
            foreach ($parts as $part) {
                ...
                /*
                 * Jika mengandung titik, misalnya:
                 * S.Pd
                 * M.Si
                 * Dr.
                 *
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | PEMENGGALAN NAMA BERDASARKAN WIDTH
        |--------------------------------------------------------------------------
        |
        | Lebar area nama di template:
        |
        | 85mm
        |
        | Kita gunakan estimasi lebar karakter Arial 12pt
        | agar pemenggalan dilakukan berdasarkan lebar,
        | bukan sekadar jumlah karakter.
        |
        */
        ...
        */
        ...
        if ($nama !== '') {
            ...
            */
            ...
            | Nama tidak muat.
            |
            | Kita pecah berdasarkan kata.
            |
            | Baris atas dibuat semaksimal mungkin,
            | lalu sisa kata masuk ke baris bawah.
            |--------------------------------------------------------------------------
            */ else {
                $namaDuaBaris = true;
                ...
                foreach ($kataNama as $index => $kata) {
                    /*
                    |--------------------------------------------------------------------------
                    | Tambahkan spasi jika bukan kata pertama
                    |--------------------------------------------------------------------------
                    */
                    ...
                    /*
                    |--------------------------------------------------------------------------
                    | Masih muat di baris atas
                    |
                    | Syarat:
                    | - Tidak boleh mengambil semua kata.
                    | - Harus menyisakan minimal satu kata untuk bawah.
                    |--------------------------------------------------------------------------
                    */
                    ...
                    | Tidak muat
                    |
                    | Kata ini dan seluruh sisa masuk baris bawah.
                    |--------------------------------------------------------------------------
                    */ else {
                        $barisBawah[] = $kata;
                ...
                /*
                |--------------------------------------------------------------------------
                | Jika ternyata baris atas kosong
                |--------------------------------------------------------------------------
                */
                ...
                if (empty($barisAtas)) {
                    /*
                    |--------------------------------------------------------------------------
                    | Paksa kata pertama menjadi baris atas
                    |--------------------------------------------------------------------------
                    */
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | MASA KERJA BERDASARKAN TMT BERKALA
        |--------------------------------------------------------------------------
        */

        $masaKerjaBerdasarkanTmtTahun_Berkala = $masaKerjaTahun_Berkala;

        $masaKerjaBerdasarkanTmtBulan_Berkala = $masaKerjaBulan_Berkala;
            ...
            @if ($namaDuaBaris)
                {{-- =================================================
                     ...
                     Contoh:
                         ...
                         Anak Agung Arim Kasunu Arya Penarungan,
                ...
                {{-- =================================================
                     ...
                     Posisi tetap sejajar dengan label Nama.
                ================================================== --}}
