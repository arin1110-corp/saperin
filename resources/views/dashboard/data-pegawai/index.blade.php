...
@section('content')
    ...
    ========================================================= --}}
        ...
        @if (session('sync_errors'))
            <div class="alert alert-warning pegawai-alert mb-3">
                <strong>Detail Error Sinkronisasi</strong>
                    ...
                    @foreach (session('sync_errors') as $error)
                        <div class="mb-2 pb-2 border-bottom">
                            ...
                            <small class="text-danger">
                                {{ $error['pesan'] ?? 'Error tidak diketahui' }}
                            </small>
                        </div>
                    @endforeach
                </div>
    ...
    ========================================================= --}}
        ...
        <div class="pegawai-header">
            ...
            <div class="pegawai-header-actions">
                ...
                <a href="{{ route('kepeg.pegawai.sinkron.simpeg') }}" class="pegawai-import-button">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('kepeg.pegawai.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="pegawai-form-row-tmt">
                            ...
                            <div class="pegawai-form-group">
                                ...
                                <input type="date" name="user_tmt_berkala" class="pegawai-form-control"
                                    value="{{ old('user_tmt_berkala') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="pegawai-form-row-tmt">
                                ...
                                <div class="pegawai-form-group">
                                    ...
                                    <input type="date" name="user_tmt_berkala" class="pegawai-form-control"
                                        value="{{ optional($pegawai->user_tmt_berkala)->format('Y-m-d') }}">
